...
export default function News({ article, ind }) {
  ...
  return (
    <div className="h-full">
      <Link to={`/article/${encodeURIComponent(ind)}`}
        state={{ article }}
        className='no-underline block h-full rounded-lg shadow-md overflow-hidden hover:shadow-lg transition cursor-pointer relative'>
